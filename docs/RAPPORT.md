...
Le choix du modèle a été réalisé en testant et comparant plusieurs modèles mettant en jeu des algorithmes différents afin de chercher le plus adapté à la prédiction du coût énergétique.

- **Des modèles linéaires régularisés** : Ridge, Lasso, ElasticNet
- **Un modèle linéaire simple** : Régression Linéaire
- **Des arbres** : Random Forest, Decision Tree, XGBoost (avec et sans pénalisation)
- **Un modèle basé sur le calcul des distances** : le KNN (K Nearest Neighbors)
...
| `nombre_niveau_logement`     | `type_batiment`                     |
| `age_batiment`               | `zone_climatique`                   |
| `altitude_moyenne`           |                                     |
...
- **30** récupérations des métriques de test : meilleure évaluation en prenant la moyenne.
- Estimation de la stabilité en calculant les intervalles de confiance à l'aide d'un **test de Student** à 95%.
...
| **Modèle**               | **Métrique** | **Moyenne (mean)** | **Écart-type (std)** | **IC95%**        |
| ------------------------ | ------------ | ------------------ | -------------------- | ---------------- |
| 🥇 **KNN**               | MAE          | 184.07 €           | 0.60                 | [183.84, 184.29] |
|                          | RMSE         | 312.38 €           | 1.03                 | [311.99, 312.76] |
|                          | R²           | 0.7456             | 0.0014               | [0.7451, 0.7461] |
| 🥈 **Lasso**             | MAE          | 289.66 €           | 0.67                 | [289.41, 289.91] |
|                          | RMSE         | 407.01 €           | 1.28                 | [406.53, 407.49] |
|                          | R²           | 0.5682             | 0.0021               | [0.5674, 0.5689] |
| 🥉 **Linear Regression** | MAE          | 290.01 €           | 0.67                 | [289.76, 290.25] |
|                          | RMSE         | 406.98 €           | 1.27                 | [406.50, 407.45] |
|                          | R²           | 0.5682             | 0.0020               | [0.5675, 0.5690] |
| 🟦 **Ridge**             | MAE          | 290.01 €           | 0.67                 | [289.76, 290.25] |
|                          | RMSE         | 406.98 €           | 1.27                 | [406.50, 407.45] |
|                          | R²           | 0.5682             | 0.0020               | [0.5675, 0.5690] |
| 🟥 **Random Forest**     | MAE          | 463.38 €           | 0.67                 | [463.13, 463.64] |
|                          | RMSE         | 578.42 €           | 1.01                 | [578.04, 578.80] |
|                          | R²           | 0.1278             | 0.0015               | [0.1273, 0.1284] |
| 🟨 **Decision Tree**     | MAE          | 463.38 €           | 0.68                 | [463.13, 463.64] |
|                          | RMSE         | 578.42 €           | 1.01                 | [578.04, 578.80] |
|                          | R²           | 0.1278             | 0.0015               | [0.1273, 0.1284] |
| 🟩 **XGBoost**           | MAE          | 463.39 €           | 0.68                 | [463.14, 463.65] |
|                          | RMSE         | 578.42 €           | 1.01                 | [578.04, 578.80] |
|                          | R²           | 0.1278             | 0.0015               | [0.1273, 0.1284] |
...
- Le modèle KNN prédit le coût énergétique avec une erreur moyenne de **184 €/an**
